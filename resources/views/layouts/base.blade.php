            ...
            <div class="topbar-menu-area">
                <div class="container">
                    <div class="topbar-menu left-menu">
                        <ul>
                            <li class="menu-item" >
                                <a title="Hotline: (+374)77 888 619" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+374)77 888 619</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    @if(Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Settings" href="{{route('admin.settings')}}">Admin Settings</a>
                                                    </li>
                                                    <li class="menu-item">
            ...
            <div class="container">
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        <a href="/" class="/"><img src="{{ asset('assets/images/eevewvw.jpg') }}" alt="mercado"></a>
                    </div>
...
<script src="https://cdn.tiny.cloud/1/xyoqyxbm7x6gpakmugmariojvv1jatis5guxqpuuoj2y0dfr/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
